...
<title>Online Continious Assessment System </title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Online Test System</span></div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Reg. number" class="form-control input-md" type="text">
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Department" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="mob" name="mob" placeholder="Contact Number" class="form-control input-md" type="text">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="#" width=100 height=100 alt="Aliyu hamisu" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Aliyu Hamisu</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">Developer</h4>
		<h4 style="font-family:'typo' ">datatel@gmail.com</h4>
		<h4 style="font-family:'typo' ">datatel Technology ,kano</h4></div></div>
		</p>
      </div>
